...
@Autonomous(name = "Blue 1: Park w/ Pixel", group = "Competition")
public class parkPixelCloseBlue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectorySequence untitled0 = drive.trajectorySequenceBuilder(new Pose2d(11.37, 61.78, Math.toRadians(-87.88)))
                .waitSeconds(1)
                .splineTo(new Vector2d(61.07, 55.61), Math.toRadians(0.00))
                .build();
