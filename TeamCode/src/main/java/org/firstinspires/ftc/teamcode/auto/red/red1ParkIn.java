...
@Autonomous(name = "Red 1: Park w/ Pixel In", group = "Competition")
public class red1ParkIn extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectorySequence untitled0 = drive.trajectorySequenceBuilder(new Pose2d(11.37, -61.78, Math.toRadians(447.88)))
                .waitSeconds(1)
                .splineTo(new Vector2d(61.07, -55.61), Math.toRadians(360.00))
                .build();
